        ...
        <>
            <section className="relative py-20 px-cont bg-gray-100">
                ...
                <div className='flex justify-between gap-5 flex-wrap items-center mb-10'>
                    <div className='flex flex-wrap rounded border border-gray-300'>
                        <button className='text-center btn hover:bg-gray-200 rounded-none'>3 Star</button>
                        <button className='text-center btn rounded-none btn-secondary'>4 Star</button>
                        <button className='text-center btn hover:bg-gray-200 rounded-none'>5 Star</button>
                        <button className='text-center flex-1 btn hover:bg-gray-200 rounded-none'>Economic</button>
                    </div>
                </div>
                <div className="grid grid-cols-1 items-center relative z-[1] gap-8">
                    {packages.map((pkg) => (
